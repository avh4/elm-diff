...
all =
    suite "Foo"
        ...
        , test "second char is equal"
            <| diffChars "ab" "1b"
            `assertEqual` [ Changed "a" "1"
                          , NoChange "b"
                          ]
        , test "two chars are equal"
            <| diffChars "ab" "ab"
            `assertEqual` [ NoChange "ab" ]
        , test "two chars are changed"
            <| diffChars "ab" "12"
            `assertEqual` [ Changed "ab" "12" ]
        , test "two chars are added"
            <| diffChars "" "ab"
            `assertEqual` [ Added "ab" ]
        , test "two chars are removed"
            <| diffChars "ab" ""
            `assertEqual` [ Removed "ab" ]
